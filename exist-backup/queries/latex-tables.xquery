...
declare variable $result := request:get-parameter("phenomenon", ("cognate-vb"));
...
(:  :let $ling-features : = doc('/db/VTLGP/ancillary/feature-library.xml')//tei:fs[tei:f/tei:fs[@type eq 'linguistic']]/@xml:id
for $fs in $ling-features return :)
