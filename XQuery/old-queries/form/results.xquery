        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="950" height="100">
            ...
            return
                <tr>
                    ...
                    <td>{(if (contains($fen/@wit, ' ')) then djb:locus($fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][1]/tei:locus/@from, $fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][1]/tei:locus/@to) || <br/>|| djb:locus($fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][2]/tei:locus/@from, $fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][2]/tei:locus/@to) else
                    ...
                    <td>{(if (contains($fen/@wit, ' ')) then $fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][1]/substring(@hand, 2)||<br/>|| $fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][2]/substring(@hand, 2) else $fen/ancestor::tei:div[1]//tei:rdg[contains(@wit, tokenize($fen/@wit, ' '))][1]/substring(@hand, 2))}</td>
                    <td>{$author/tei:persName/string()}</td>
                    <td>{$author/tei:floruit/@from||'-'||$author/tei:floruit/@to|| ' (' ||$author/tei:floruit/@period||')'}</td>
                     <td>{$fen/ancestor::tei:div[1]/replace(substring(@corresp, 2), '(\d|[a-z])([A-Z])', '$1, $2')}</td>
