...
<svg
    ...
    <g
        ...
        <text
            x="25"
            y="-307"><tspan class="en">Linguistic variants</tspan><tspan class="gl pt">Variantes de li<tspan class="pt">&#769;</tspan>ngua</tspan></text>
        <text
            x="-300"
            y="-30"
            text-anchor="end"><tspan class='gl pt en'>Erro<tspan class="en">r</tspan></tspan></text>
        <text
            y="17"
            x="323"><tspan class="en">Other</tspan><tspan class="gl pt">Outras</tspan></text>
        <text
            x="-32"
            text-anchor="end"
            y="310"><tspan class="pt">Lições divergentes</tspan><tspan class="gl">Leccións diverxentes</tspan><tspan class="en">Divergent readings</tspan></text>
    </g>
    {
