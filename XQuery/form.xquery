...
let $phonetic := $ling-features[tei:f/tei:fs[not(@n)][matches(@feats, '#(vowel$|cons$|nasal$|sibil$|diphthong$|pal$)')]]
let $morph := $ling-features[tei:f/tei:fs[not(@n)][matches(@feats, '#(past$|pr$|det$|prep$|conj$)')]]
let $other := $ling-features[tei:f/tei:fs[not(@n)][not(matches(@feats, '#(past$|pr$|det$|prep$|conj$|vowel$|cons$|nasal$|sibil$|diphthong$|pal$)'))]]
...
return
    ...
    (<form
        ...
        <fieldset>
            <legend><span
                    class="pt">Fenómenos morfológicos</span></legend>
    ...
    <form
        ...
        <fieldset>
            <legend><span
                    class="en">Morphological phenomena</span></legend>
